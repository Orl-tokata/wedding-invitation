...
export const en: Translations = {
  inviteLine: 'We respectfully invite you as an honored guest.',
  inviteParagraph:
  ...
  mr: 'Mr.',
  mrs: 'Mrs.',
  groomFatherName: 'Bin Orl',
  groomMotherName: 'Rous Phal',
  brideFatherName: 'Phin Phan',
  brideMotherName: 'Maen Vuon',
  groomName: 'Orl Tokata',
  brideName: 'Phin Phanou',
