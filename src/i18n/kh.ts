...
export const kh: Translations = {
  inviteLine: 'សូមគោរពអញ្ជើញជាភ្ញៀវកិត្តិយស',
  inviteParagraph: 'សម្ដេច​​ ទ្រង់ ឯកឧត្តម​ អ្នកឧកញ៉ា​ លោកឧកញ៉ា លោកជំទាវ លោក លោកស្រី អ្នកនាងកញ្ញា និងប្រិយមិត្ត អញ្ជើញចូលរួមជាអធិបតី និងជាភ្ញៀវកិត្តិយស ដើម្បីប្រសិទ្ធិពរជ័យ សិរីសួស្ដី ជ័យមង្គល ក្នុង ពិធីរៀបអាពាហ៍ពិពាហ៍ កូនប្រុស កូនស្រី របស់ពួកយើងខ្ញុំ។',
  inviteParagraphDate: 'ដែលប្រព្រឹត្តទៅនៅថ្ងៃ',
  date: 'អាទិត្យ ទី២៦ ខែមេសា ឆ្នាំ២០២៦',
  dateInKhmer: 'អាទិត្យ ១០កើត ខែ ពិសាខ ឆ្នាំ មមី អដ្ឋស័ក ព.ស.២៥៦៩',
  dateInEnglish:'ត្រូវនឹងថ្ងៃ ២៦ ខែមេសា ឆ្នាំ២០២៦',
  ...
  mr: 'លោក',
  mrs: 'អ្នកស្រី',
  groomFatherName: 'ប៊ិន អុល',
  groomMotherName: 'រស់ ផល',
  brideFatherName: 'ភិន ផាន',
  brideMotherName: 'ម៉ែន វួន',
  groomName: 'អុល តុក្កតា', 
  brideName: 'ភិន ផានូ',
  ...
  artist: 'Artist',
  closePlayer: 'បិទអ្នកចាក់',
  openPlayer: 'បើកអ្នកចាក់',
  play: 'ចាក់',
  pause: 'ផ្អាក',
  closeModal: 'បិទ',
  prevSlide: 'ស្លាយមុន',
